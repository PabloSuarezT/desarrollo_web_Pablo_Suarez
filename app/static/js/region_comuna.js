...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // El input 'otro-contacto' original ya no es necesario si los generamos dinámicamente
    ...
    // CORRECCIÓN 1: Se eliminó .value de la cadena de entrada
    ...
    // CORRECCIÓN 2: Se modificó la regex para permitir puntos (.) y espacios (\s)
    ...
    // --- Lógica para mostrar/generar inputs de contacto dinámicos (NUEVA FUNCIONALIDAD) ---
    contactSelect.addEventListener('change', (event) => {
         ...
         if (selectedOptions.length > 0) {
             ...
             selectedOptions.forEach(option => {
                 ...
                 label.textContent = `ID/URL para ${contactName}: `;
                 ...
                 // Nombre único para el envío de datos: contacto_url[whatsapp], contacto_url[otra], etc.
                 input.name = `contacto_url[${contactValue}]`; 
                 input.placeholder = `Escribe el ID o URL para ${contactName}`;
                 input.required = true; 
                 input.minlength = 4;
                 input.maxlength = 50;
        ...
        if (errores.length > 0) {
            ...
            if (confirmacion) {
                formulario.innerHTML = `
                    ...
                    <div class="volver-portada-container">
